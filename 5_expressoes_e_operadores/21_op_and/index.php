<?php 
//and é representado e usado como && (dois es comerciais juntos)
...
if($a > $b && $c == $d)
{
    echo "<br>Entrou no if 5<br>";
}

if($b < $a && $c >= $d)
{
    echo "<br>Entrou no if 6<br>";
}

if($b === $a && $c > $d)
{
    echo "<br>Entrou no if 7<br>";
}

if(($b <= $a && $c >= $d) && $a > $b)
{
    echo "<br>Entrou no if 8<br>";
}

if($b <= $a && $c >= $d && $c === $a)
{
    echo "<br>Entrou no if 9<br>";
}